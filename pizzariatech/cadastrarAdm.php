    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 arrumar">
                <a href="EntregasAdm.php">
                    <i class="bi bi-car-front-fill"></i><br>
                    <span>Entregas</span>
                </a>
            </div>
            <div class="col-md-4 arrumar">
                <a href="FornecedoresAdm.php">
        ...
        <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 d-flex arrumar">
                    <a href="PedidosAdm.php">
                        <i class="bi bi-bag-plus-fill"></i><br>
                        <span>Finaizar Pedidos</span>
                    </a>
                </div>
        </div>
    </div>

...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 card p-4">
            <form action="includes/criarPedidosItensAdm.php" method="post">    
                <input type="" name="idPedidos" value="<?php echo $_GET['idPedido'];?>" >
                    ...
                    <?php
                        ...
                        while($dados = mysqli_fetch_assoc($result)){
                            if($_SESSION['tipoUserUsuarioLogado'] == 2){
                                $acoes = "<a class='btn btn-warning' href='PedidosAdm.php?idPedidos=".$dados['idPedidosItens']."'>Editar</a>

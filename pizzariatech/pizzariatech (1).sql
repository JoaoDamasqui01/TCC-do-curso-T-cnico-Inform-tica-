...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/12/2024 às 17:24
...
(1, 'Amigão', 'AV. Claudia Tupan, 394', '48346729', '256955');
...
--
ALTER TABLE `entregas`
  MODIFY `idEntregas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pedidositens`
  MODIFY `idPedidosItens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `itens`
  ADD CONSTRAINT `fk_Itens_Marcas` FOREIGN KEY (`idMarcas`) REFERENCES `marcas` (`idMarcas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Itens_TiposItens` FOREIGN KEY (`idTiposItens`) REFERENCES `tipositens` (`idTiposItens`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Itens_fornecedores` FOREIGN KEY (`idFornecedores`) REFERENCES `fornecedores` (`idFornecedores`) ON DELETE NO ACTION ON UPDATE NO ACTION;

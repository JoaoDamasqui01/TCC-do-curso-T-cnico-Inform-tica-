...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/12/2024 às 01:44
...
(7, 'Natural Destribuidora', 'Av.Brasil', '65676725', '5843454'),
(8, 'Natural Destribuidora', 'Av.Brasil', '65676725', '5843454');
...
(13, 1, 1, 4, 'massa de tomate', 0, 0.00),
(14, 1, 1, 4, 'Cebola', 0, 0.00);
...
--
ALTER TABLE `entregas`
  MODIFY `idEntregas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `itens`
  MODIFY `idItens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `pedidos`
  MODIFY `idPedidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

<?php
    ...
    if (isset($_POST['idMarcas']) && !empty($_POST['idMarcas'])) {
        ...
        if (mysqli_query($conn, $sql)) {
            header("Location: ../MarcasAdm.php?tipo=sucesso&mensagem=Marca atualizada com sucesso");
        } else {
            header("Location: ../MarcasAdm.php?tipo=erro&mensagem=Erro ao atualizar a marca");
        }
    } else {
        // Inserir
        ...
        if (mysqli_query($conn, $sql)) {
            header("Location: ../MarcasAdm.php?tipo=sucesso&mensagem=Marca cadastrada com sucesso");
        } else {
            header("Location: ../MarcasAdm.php?tipo=erro&mensagem=Erro ao cadastrar a marca");
        }
    }
?>

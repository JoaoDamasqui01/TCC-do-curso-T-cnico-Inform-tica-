<?php
	...
	if ($idItens > 0) {
		...
		if(mysqli_query($conn, $sql)){
			//header("Location: ../itenAdm.php?tipo=sucesso&mensagem=Item criado com sucesso");
        } else {
            header("Location: ../itenAdm.php?tipo=erro&mensagem=Erro ao Criar o item");
        }
		...
		if (mysqli_query($conn, $sql)) {
            header("Location: ../itenAdm.php?tipo=sucesso&mensagem=Item cadastrada com sucesso");
        } else {
            header("Location: ../itenAdm.php?tipo=erro&mensagem=Erro ao cadastrar o Item");
        }
	}
